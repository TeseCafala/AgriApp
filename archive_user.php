...
if (isset($_GET['id'], $_GET['type'])) {
    ...
    if (mysqli_query($conn, $query)) {
        header("Location: admin_dashboard.php?page=users&success=Usuário arquivado com sucesso");
        exit;
    } else {
        header("Location: admin_dashboard.php?page=users&error=Erro ao arquivar usuário");
        exit;
    }
} else {
